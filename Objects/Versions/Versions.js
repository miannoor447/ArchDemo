    ...
    "versions": {
        ...
        "=1.0": {
            ...
            "data": {
                ...
                "query": {
                    "queryNature": "SELECT",
                    "queryPayload": "SELECT *, COUNT(*) OVER () AS table_count FROM Versions",
                    "database": "projectDB"
                },
                "utilityFunctions": {
    ...
    "versions": {
        ...
        "=1.0": {
            ...
            "data": {
                ...
                "query": {
                    "queryNature": "SELECT",
                    "queryPayload": "SELECT * FROM Versions WHERE version_id = {{id}}",
                    "database": "projectDB"
                },
                "utilityFunctions": {
                    "callbackFunction": null,
    ...
    "versions": {
        ...
        "=1.0": {
            ...
            "data": {
                ...
                "query": {
                    "queryNature": "UPDATE",
                    "queryPayload": "UPDATE Versions SET version_id = {{version_id}}, version = {{version}}, status = {{status}}, updated_by = {{updated_by}}, created_at = {{created_at}}, updated_at = {{updated_at}} WHERE version_id = {{version_id}}",
                    "database": "projectDB"
                },
                "utilityFunctions": {
                    "callbackFunction": null,
    ...
    "versions": {
        ...
        "=1.0": {
            ...
            "data": {
                ...
                "query": {
                    "queryNature": "UPDATE",
                    "queryPayload": "UPDATE Versions SET status = 'inactive' WHERE version_id = {{version_id}}",
                    "database": "projectDB"
                },
                "utilityFunctions": {
                    "callbackFunction": null,
    ...
    "versions": {
        ...
        "=1.0": {
            ...
            "data": {
                ...
                "query": {
                    "queryNature": "INSERT",
                    "queryPayload": "INSERT INTO versions (version_id, version, status, updated_by, created_at, updated_at) VALUES ({{version_id}}, {{version}}, {{status}}, {{updated_by}}, {{created_at}}, {{updated_at}})",
                    "database": "projectDB"
                },
                "utilityFunctions": {
                    "callbackFunction": null,
