              ...
              "steps": [{
                ...
                "data": {
                  ...
                  "apiInfo": {
                    "query": {
                      "queryNature": "INSERT",
                      "queryPayload": "INSERT INTO chatting_groups (chatting_group_name, updated_by) VALUES ({{chatting_group_id}}, {{chatting_group_name}}, {{status}}, {{updated_by}}, {{updated_at}}, {{created_at}})",
                      "database": "projectDB"
                    },
                    "utilityFunctions": {
                      "callbackFunction": null,
