    ...
    "versions": {
        ...
        "=1.0": {
            ...
            "data": {
                ...
                "query": {
                    "queryNature": "SELECT",
                    "queryPayload": "SELECT *, COUNT(*) OVER () AS table_count FROM User_role_designation_permissions",
                    "database": "projectDB"
                },
                "utilityFunctions": {
    ...
    "versions": {
        ...
        "=1.0": {
            ...
            "data": {
                ...
                "query": {
                    "queryNature": "SELECT",
                    "queryPayload": "SELECT * FROM User_role_designation_permissions WHERE user_role_designation_permission_id = {{id}}",
                    "database": "projectDB"
                },
                "utilityFunctions": {
                    "callbackFunction": null,
    ...
    "versions": {
        ...
        "=1.0": {
            ...
            "data": {
                ...
                "query": {
                    "queryNature": "UPDATE",
                    "queryPayload": "UPDATE User_role_designation_permissions SET user_role_designation_permission_id = {{user_role_designation_permission_id}}, user_role_designation_department_id = {{user_role_designation_department_id}}, permission_id = {{permission_id}}, status = {{status}}, updated_by = {{updated_by}}, updated_at = {{updated_at}}, created_at = {{created_at}} WHERE user_role_designation_permission_id = {{user_role_designation_permission_id}}",
                    "database": "projectDB"
                },
                "utilityFunctions": {
                    "callbackFunction": null,
    ...
    "versions": {
        ...
        "=1.0": {
            ...
            "data": {
                ...
                "query": {
                    "queryNature": "UPDATE",
                    "queryPayload": "UPDATE User_role_designation_permissions SET status = 'inactive' WHERE user_role_designation_permission_id = {{user_role_designation_permission_id}}",
                    "database": "projectDB"
                },
                "utilityFunctions": {
                    "callbackFunction": null,
    ...
    "versions": {
        ...
        "=1.0": {
            ...
            "data": {
                ...
                "query": {
                    "queryNature": "INSERT",
                    "queryPayload": "INSERT INTO user_role_designation_permissions (user_role_designation_permission_id, user_role_designation_department_id, permission_id, status, updated_by, updated_at, created_at) VALUES ({{user_role_designation_permission_id}}, {{user_role_designation_department_id}}, {{permission_id}}, {{status}}, {{updated_by}}, {{updated_at}}, {{created_at}})",
                    "database": "projectDB"
                },
                "utilityFunctions": {
                    "callbackFunction": null,
